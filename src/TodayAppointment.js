...
function TodayAppointment() {
  ...
  const appointment = details.filter((data) => todayDate === data.bookingDate);
  // const handleButtonClick=(id)=>{
  //   alert('The button was clicked'+ id);
  // }
const updateAppointmentData=async(id,data)=>{
await updateData("booking",id,data);
}
  const columns = [
    { title: "ID", field: "id" },
    ...
    // {title:"Checked", field:"status", hozAlign:"center", editor:true, formatter:"tickCross"},
    {
      title: "Checked",
      field: "status",
      hozAlign: "center",
      ...
      cellClick: function (e, cell) {
        ...
        const updatedData = {
          ...rowData,
          status: !rowData.status, // Toggle the status value
        };
        // Assuming you have a function to update the data in your table
        // You need to implement this function according to your data management logic
        updateAppointmentData(rowData.id, updatedData);
      },
    },
